							...
							<%
								...
								<li class="lm-imgItem">
					                ...
					                <div class="buttons">
											...
											<a class="btn wishlist" href="/kongtiaoshop/kongtiaoshop?ac=addfav&goodid=<%=goodsmap.get("id") %>&page=index.jsp" title="收藏此空调"><span class="glyphicon glyphicon-heart"></span></a>
								    </div>
								    <div class="caption">
