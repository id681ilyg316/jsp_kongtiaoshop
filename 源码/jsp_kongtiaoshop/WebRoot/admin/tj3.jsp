...
<div class="row-fluid">
    <div class="block">
  	...
  	<script language="JavaScript" src="/kongtiaoshop/admin/FusionCharts.js"></script>
  	 <script type="text/javascript">
		var chart = new FusionCharts("/kongtiaoshop/admin/FCF_Column3D.swf", "ChartId", "900", "300");
