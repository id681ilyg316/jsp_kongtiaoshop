...
<html lang="en">
  ...
  <body class="">
    ...
    <%	 CommDAO dao = new CommDAO(); 
	 ...
	 String url = "/kongtiaoshop/admin/ppinfo.jsp?1=1";
				...
				<div class="btn-toolbar">
					<div class="search-well">
						<form action="admin/ppinfo.jsp?f=f" class="form-inline">
						    ...
						    <button class="btn btn-primary" onclick="ppinfoadd()" type="button"><i class="icon-plus"></i> 空调品牌</button>
						</form>	
					</div>  	
				</div>
