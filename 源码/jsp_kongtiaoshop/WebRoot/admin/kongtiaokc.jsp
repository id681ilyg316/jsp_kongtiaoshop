...
<html lang="en">
  ...
  <body class="">
    ...
    <%	 CommDAO dao = new CommDAO(); 
	 ...
	 String url = "/kongtiaoshop/admin/kongtiaokc.jsp?1=1";
			...
			<%}%>
				<div class="btn-toolbar">
					<div class="search-well">
						<form action="admin/kongtiaokc.jsp?f=f" class="form-inline">
   	...
   	for(HashMap map:list){
        ...
        <tr>
          ...
          <td>
		    ...
		    <font color="red">(该空调库存不足，请补仓)</font>
		    <%} %>
          </td>
          <td>
              <a href="admin/kongtiaokcadd.jsp?gid=<%=map.get("id") %>" title="入库"><i class="icon-plus"></i></a>
          </td>
        </tr>
        <%} %>
      </tbody>
