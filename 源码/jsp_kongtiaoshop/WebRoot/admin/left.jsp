...
<!-- <span class="label label-info">+3</span> -->
        ...
        <ul id="accounts-menu" class="nav nav-list collapse in">
            <li><a href="admin/protype.jsp">空调类别</a></li>
            <li><a href="admin/ppinfo.jsp">空调品牌</a></li>
            <li><a href="admin/kongtiaogl.jsp">空调管理</a></li>
            <li><a href="admin/kongtiaokc.jsp">空调库存</a></li>
