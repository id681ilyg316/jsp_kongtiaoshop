...
<head>
  ...
  HashMap map = dao.select("select * from kongtiao where id="+id).get(0);
...
<body>
				...
				<div id="main-content" class="col-md-8">
					...
					<div class="product-desc">
						<ul class="nav nav-tabs">
							<li class="active"><a href="javascript:void(0)" onclick="selectTag('tagContent0',this)">空调描述</a></li>
							<li><a href="javascript:void(0)" onclick="selectTag('tagContent1',this)">空调评价</a></li>
						</ul>
						<div class="tab-content" id="tags">
							...
							<div id="tagContent1" class="tab-pane fade">
							  ...
							  <table class="bordered">  
	                                ...
	                                String url ="/schoolseclivekongtiaojysys/kongtiaox.jsp?1=1&id="+id;
	...
	function tobuy(){     
		 ...
		 $.ajax({  
		        type: "POST",      
		         url: "/kongtiaoshop/kongtiaoshop?ac=tobuy", //servlet的名字     
		          data: "gid="+gid+"&sl="+sl, 
		         success: function(data){       
		    if(data=="true"){     
		    	$("#tsinfo").show();
