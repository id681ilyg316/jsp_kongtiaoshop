...
<body>
			...
			<div class="row">
				...
				<div class="col-xs-6">
					<ul class="top-link">
						...
						<li><a href="/kongtiaoshop/admin" target="_blank" ><span
						...
						<li><a href="#" role="button" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li class="divider"></li>
								<li><a tabindex="-1" href="favkongtiao.jsp"><i
								...
								<li class="divider"></li>
								<li><a tabindex="-1"
									href="/kongtiaoshop/kongtiaoshop?ac=frontexit"><i
										class="glyphicon glyphicon-log-out"></i>安全退出</a>
								</li>
								<li><a target="_blank" href="/kongtiaoshop/admin"><span
								class="glyphicon glyphicon-user"></span> 管理员登录</a>
						</li>
							</ul></li>
						<%
	...
	<header class="container">
		<div class="row">
			<div class="col-md-4">
				<div id="logo">
					<span style="font-size:25px">空调商城</span>
				</div>
			</div>
			<div class="col-md-4">
				<form class="form-search" action="kongtiao.jsp" method="post">
					<input type="text" placeholder="空调编号或名称..."
						...
						<div class="dropdown-menu">
							<div class="dropdown-inner">
								<ul class="list-unstyled">
									...
									%>
									<li><a href="kongtiao.jsp?key2=<%=stypemap.get("id")%>"><%=stypemap.get("typename")%></a>
									</li>
									<%
										}
									%>
