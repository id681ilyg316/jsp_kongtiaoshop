  ...
  HashMap member = dao.select("select * from member where id="+membersession.get("id")).get(0); %>
	...
	<div id="page-content" class="single-page">
		<div class="container">
			...
			ArrayList<HashMap> goodlist = (ArrayList<HashMap>)dao.select("select *,a.id as aid,b.id as bid from car a,kongtiao b where a.gid=b.id and a.mid='"+member.get("id")+"' and b.delstatus='0' order by aid desc");
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-8 ">
					<center><a href="kongtiao.jsp" class="btn btn-1">继续购物</a></center>
				</div>
			</div>
			<div class="row">
				<div class="pricedetails">
					<div class="col-md-4 col-md-offset-8">
						...
						<%}else{ %>
						<center><a href="kongtiao.jsp" class="btn btn-1">购物车内无空调，快去选购吧!</a></center>
						<%} %>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	function updatecar(i){
		...
		if(sl==""||sl<=0){
		 ...
		 $.ajax({  
		        type: "POST",      
		         url: "/kongtiaoshop/kongtiaoshop?ac=updatecart", //servlet的名字     
	...
	function updatetprice(){
		$.ajax({  
	        type: "POST",      
	         url: "/kongtiaoshop/kongtiaoshop?ac=updatetprice", //servlet的名字     
	          data: "", 
	         success: function(data){       
	    if(data!=null){     
	    	$("#dprice").html(data);
